...
<div class="row justify-content-center">
    <div class="col-md-6">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-4 pb-3 mb-3">
            <h1 class="h3" style="color: #1f1f1f; font-weight: 400;">Add Expenditure</h1>
            ...
            <div class="google-card">
                <div class="google-row">
                    ...
                    <div class="google-content">
                        ...
                        <input type="date" name="date" class="google-input" value="<?= date('Y-m-d') ?>" required>
                    </div>
                </div>
                ...
                <div class="google-row">
                    ...
                    <div class="google-content">
                        ...
                        <input type="number" step="0.01" min="0" name="amount" class="google-input" placeholder="0.00" required>
                    </div>
                </div>
                ...
                <div class="google-row" style="align-items: flex-start;">
                    ...
                    <div class="google-content">
                        ...
                        <textarea name="description" class="google-textarea" rows="2" placeholder="Explain what this expenditure is for..."></textarea>
                    </div>
                </div>
            </div>
            
            <div class="d-flex justify-content-end mb-5">
                <button type="submit" class="btn-save">Save Expenditure</button>
            </div>
        </form>
    </div>
</div>
