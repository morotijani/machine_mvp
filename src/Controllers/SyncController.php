...
class SyncController {
    ...
    public function receiveDatabase() {
        ...
        try {
            ...
            $tables = ['settings', 'users', 'customers', 'items', 'item_bundles', 'sales', 'sale_items', 'sale_returns', 'sale_return_items', 'payments', 'payment_requests', 'inventory_logs', 'item_logs', 'debtors', 'debt_repayments', 'customer_debt_payments', 'expenditures', 'coffer_transactions', 'user_logins'];
